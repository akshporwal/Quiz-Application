...
def about():
	print('''\n==========ABOUT US==========
This project has been created by Aksh Porwal, Bonny Porwal and Rahul Khangar.
It is a Python Project for our Major Assesment.''')
...
if __name__ == "__main__":
	...
	while choice != 7:
		...
		print('6. INSTRUCTIONS ON HOW TO PLAY THE GAME')
		print('7. EXIT')
		print('8. ABOUT US')
